...
public interface GroupService {
    GetGroupResponse createGroup(CreateGroupRequest request, String userEmail);
    GroupDetailsDTO getGroupDetails(Long groupId, String userEmail);
    GetUserGroupsResponse getUserGroups(String userEmail);
    GetGroupResponse updateGroup(Long groupId, UpdateGroupRequest updateGroupRequest, String userEmail);
